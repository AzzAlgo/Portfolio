# COPY.md — Final EN copy for Phase B

> **Authoritative copy for `index.html`.** If `index.html` and this file diverge, this file wins and the HTML is updated to match.
> Language: EN (FR follow-up per OD-W1).
...
- **CTAs:**
  ...
  - Secondary: `Download CV` *(button with EN / FR dropdown — click-to-open on touch)*
...
## Selected Engagements — 3 featured cards
...
## Career — full timeline (Education / Experience / Certifications)

Eyebrow: `Career`
Heading: `Fifteen years of delivery.`

### Tab 1 — Education

> **MBA, Finance specialization** — emlyon Business School — 2017–2018
> **MEng, Mechanical Engineering** — Université de Technologie de Belfort-Montbéliard (UTBM) — 2005–2008
> **BEng, Industrial Engineering** — Lebanese University, Faculty of Technology — 2002–2005
...
> · **Project Supply Manager** — Gen-III nuclear critical supplier portfolio · 12 months · 2020–2021
> · **Contract Manager** — Paris high-rise development claim preparation · 4 months · 2025
> · **Investment Project Manager** — ~€20 M CAPEX forging facility portfolio · 24 months · 2018–2020

> **Suido Kiko Middle East — Team Leader, Engineering**
> Jeddah, Saudi Arabia · 2013–2017
> Engineering lead on three Membrane Bioreactor (MBR) water-treatment EPC plants — KUBOTA and GE MBR technologies. Up to €20 M per project. Multidisciplinary engineering team. Deployed Biowin, AutoCAD P&ID and Plant 3D to lift study quality and productivity.

> **Suido Kiko Middle East — Project Engineer**
> Jeddah, Saudi Arabia · 2009–2013
> Construction-division support to the Project Manager on six industrial wastewater treatment stations for the National Water Company. Primavera P6 scheduling and progress reporting. Supervised mechanical and process installation and commissioning. Punch-list closure and as-built documentation through final acceptance.

> **Tenneco — Mechatronics Engineer Internship**
> 2008
> **Liebherr France — Mechanical Engineer Internship**
> 2006–2007
...
## Toolkit — 3 column tag grid

Eyebrow: `Toolkit`
Heading: `Tools and methods.`

### Column 1 — Project & Cost
`Primavera P6` `MS Project` `EVM (CPI / SPI / EAC / ETC / TCPI)` `Earned Schedule` `AACE-aligned practice` `Trello` `Jira`

### Column 2 — Data & Analytics
`Power BI` `Power Query` `@RISK` `Monte Carlo` `Python` `FORTRAN` `C/C++`

### Column 3 — Engineering
`AutoCAD` `AutoCAD P&ID` `Plant 3D` `Catia` `Ansys` `Biowin`
...
Eyebrow: `Contact`
Heading: `Open to senior cost management missions.`

- **Email card:** `azzam.hannouf@gmail.com` *(mailto link)*
- **Location card:** `Lyon, France` *(no map widget — text only)*
- ⚠ **No phone number on this page** *(per OQ #4 decision — phone stays on the CV PDFs only)*

### Form fields

- `Your name` *(text, required, autocomplete=name)*
- `Your email` *(email, required, autocomplete=email, inputmode=email)*
- `Subject` *(text, required)*
- `Your message` *(textarea, required, rows=6)*
- Honeypot field: `<input name="_honey" type="text" style="display:none">` *(FormSubmit convention)*
- Hidden: `<input type="hidden" name="_captcha" value="false">`
- Hidden: `<input type="hidden" name="_subject" value="New message from azzalgo.github.io">`
...
> Layout: minimal 3-column grid on desktop, single column on mobile.
> Column 1 — wordmark: `Azzam HANNOUF` / `Cost Management & EVM Consultant`
> Column 2 — quicklinks: `About` `Expertise` `Engagements` `Career` `Contact`
> Column 3 — socials (icon row): LinkedIn (primary), GitHub. *(Per OQ #6: Facebook and Instagram are removed from the public site footer; LinkedIn + GitHub only.)*

Copy line at bottom: `© 2026 Azzam HANNOUF. All rights reserved.`

---

## Skip link (a11y)

> First focusable element of the page: `<a class="skip-link" href="#main">Skip to content</a>`
...
- Mobile nav toggle: `aria-label="Open menu"`
- Mobile nav close: `aria-label="Close menu"`
- Scroll-up button: `aria-label="Scroll to top"`
- Social links: `aria-label="LinkedIn profile (opens in new tab)"`, etc.
